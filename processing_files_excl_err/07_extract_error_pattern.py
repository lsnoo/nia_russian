...
with open('./data_1114/results/per_utt_results', 'r') as f: lines = f.readlines()
...
with open('./data_1114/results/error_patterns_dic', 'w') as f: json.dump(error_dic, f, indent=4)
print(error_dic)

sorted_tuple = sorted(error_dic.items(), key = lambda item: item[1], reverse = True)
print(sorted_tuple[:50])
with open('./data_1114/results/error_patterns_dic_50', 'w') as f: f.write('\n'.join(f'{tup[0]} {tup[1]}' for tup in sorted_tuple))
