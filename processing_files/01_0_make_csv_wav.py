...
audio_save_dir = '/data/lsnoo/nia_ru/audio_1220/'

with open('./data_1220/original_json/ru.json', 'r') as f: entire_dic = json.load(f)
...
with open('data_1220/russian_1220.csv', 'w') as f: f.writelines(new_lines)
